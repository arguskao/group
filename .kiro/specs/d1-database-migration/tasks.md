...
- [x] 6.3 撰寫單元測試：MigrationTool
  - 測試 localStorage 讀取
  - 測試遷移結果摘要格式
  - 測試錯誤記錄收集
  - _需求：3.1, 3.4_

- [x] 7. 更新 CSV 匯出功能以支援 D1
